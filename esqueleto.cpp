...
int main(int argc, char* argv[])
{
	...
	//para trabar el main debo hacer un wait de adam y lilith y para trabarlos a ellos un wait de sus hijos
	//puedo hacer cadena de waits para trabar a los demas
		 						  ...
		 						  string my_type)
{
	...
	default_random_engine generator (3);//semilla aca
